...
categories: ["Gear", "Triathlon"]
tags: ["Bike Fit", "Cervelo", "P5", "TT Bike", "Cleat Position", "Retül"]
...
![Before (left) vs After (right): pedal at horizontal — the flatter back angle after the fit is immediately visible](before-after-horizontal.webp)
...
![Cleat lever mechanics: traditional position (left) vs rearward position (right) — shorter lever arm, less calf demand](cleat-lever-diagram.svg)
...
![FORM Cleat Extender Plates, one pair](form-cleat-extender.webp)
